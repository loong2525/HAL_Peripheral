...
MPU6050 mpu6050 = {0.0f, 0.0f, 0.0f};
...
int MPU6050_DMP_Get_Date(MPU6050* pmpu6050)
{
    ...
    if(sensors & INV_WXYZ_QUAT)
    {
        ...
        pmpu6050->pitch = asin(-2 * q1 * q3 + 2 * q0 * q2) * 57.3; // pitch
        pmpu6050->roll = atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2 * q2 + 1) * 57.3; // roll
        pmpu6050->yaw = atan2(2 * (q0 * q3 + q1 * q2), q0 * q0 + q1 * q1 - q2 * q2 - q3 * q3) * 57.3; // yaw
    }
