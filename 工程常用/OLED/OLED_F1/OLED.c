...
/***************************************************************************************
  * OLED屏幕显示，本程序借鉴江协科技，为1.3寸
  【[模块教程] 第1期 0.96寸OLED显示屏】 
  https://www.bilibili.com/video/BV1EN41177Pc/?share_source=copy_web&vd_source=c3e2fc68aa51e67bd3f2be57434d3d1c
  ***************************************************************************************
  */
...
void OLED_Init(void)
{
	...
	OLED_WriteCommand(0xC8);	//设置上下方向，0xC8正常，0xC0上下反置//***重点***//
...
void facial_expression(uint8_t num)
{
	OLED_Clear();
	if(num==1)
